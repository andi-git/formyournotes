...
public class ActionBarHelperHoneycomb extends ActionBarHelper {
	...
	protected ActionBarHelperHoneycomb(Activity activity, ActionBarR actionBarR) {
		super(activity);
	...
	public void setRefreshActionItemState(boolean refreshing) {
		...
		final MenuItem refreshItem = mOptionsMenu.findItem(actionBarR.getId()
				.getMenuRefresh());
		if (refreshItem != null) {
			if (refreshing) {
				if (mRefreshIndeterminateProgressView == null) {
					...
					mRefreshIndeterminateProgressView = inflater.inflate(
							actionBarR.getLayout()
									.getActionbarIndeterminateProgress(), null);
				}
